...
var debug                   = require('debug')('roon-extension-marantz-telnet')
  , info                    = require('debug')('roon-extension-marantz-telnet:info')
  , warn                    = require('debug')('roon-extension-marantz-telnet:warn')
  , RoonApi                 = require('node-roon-api')
  , RoonApiSettings         = require('node-roon-api-settings')
  , RoonApiStatus           = require('node-roon-api-status')
  , RoonApiVolumeControl    = require('node-roon-api-volume-control')
  , RoonApiSourceControl    = require('node-roon-api-source-control')
  , AVRAsyncHelper          = require('./lib/MarantzAsyncHelper.js');

var avr = {};
var roon = new RoonApi({
    extension_id: 'org.mccainca.roon.marantz',
    display_name: 'Marantz SR6013',
    display_version: '0.0.1',
    publisher: 'Al McCain',
    email: 'mccainca@gmail.com',
    website: 'https://github.com/mccainca/roon-extension-marantz-telnet',
    log_level: 'debug',
});
...
function make_layout(settings)
{
    ...
    l.layout.push({
        ...
        subtitle: "The IP address or hostname of the Marantz receiver.",
        maxlength: 256,
        setting: "hostname",
    });
    l.layout.push({
        type:    "dropdown",
        title:   "Source",
        subtitle: "The source Roon uses on your Marantz receiver (ie 'CD')",
        values:  [
            { value: 'CD',      title: 'CD' },
...
var svc_settings        = new RoonApiSettings(roon,{
    ...
    save_settings: function(req, isdryrun, settings) {
        ...
        if (!isdryrun && !l.has_error)
        {
            ...
            setup_marantz_connection(mysettings.hostname);
        }
    }
    /*
...
async function setup_marantz_connection(host)
{
    info("setup_marantz_connection (" + host + ")");
